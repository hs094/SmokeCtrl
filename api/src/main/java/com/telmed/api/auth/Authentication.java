...
import com.telmed.api.auth.model.*;
import com.telmed.api.auth.repo.*;
import com.telmed.api.auth.model.RegStats;
import com.telmed.api.auth.repo.RegStatsRepository;
...
public class Authentication {
    ...
    @Autowired
    public Authentication(UserRepository userRepository, RegStatsRepository regStatsRepository) {
