...
#     template=("Please respond to the following question in no more than 300 tokens. "
#               "You are a Psychiatrist with expertise in Tobacco and Alcohol Addiction. "
#               "Format your response using Markdown and separate each point with '\n':\n\n"
#               "{input_text}")
# )
...
#             template=
#             """
#             Please limit your response to a maximum of 300 tokens.
#             Focus solely on answering the question posed.
...
#             - End with key details, examples, or insights relevant to the question.

#             Use clear and professional language that is accessible to a laymen and wide audience, ensuring your response is informative and engaging.
#             """
#         )
...
# prompt_template = PromptTemplate(
#     input_variables=["input_text"],
#     template=("Please respond to the following question in no more than 200 words."
#               "You are an expert Health Medical Practitioner."
#               "Format your response using Markdown and separate each point with '\n':\n\n"
#               "{input_text}")
# )
...
#         self.max_tokens = 512  # Example limit for the total response length
