...
class _ChatPageState extends State<ChatPage> {
  ...
  void getAnswer(String prompt) async {
    ...
    List<Map<String, String>> msg = [{"content": prompt}];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("ChatMEDiX", style: TextStyle(fontWeight: FontWeight.bold))
      ),
      body: SafeArea(
        child: Stack(
          children: [
                            ...
                            Positioned(
                              ...
                              child: MaterialButton(
                                ...
                                child: Ink(
                                  ...
                                  child: Container(
                                    constraints: const BoxConstraints(minWidth: 50.0, minHeight: 45.0),
